...
public class QueryConstants {
    ...
    public static final String ENABLE_TOOLS_QUERY = "UPDATE AIT_DBPROP SET " +
            "FUNNEL_DISCOVERY = CASE WHEN <ENABLE_FUNNEL> = 1 THEN 1 ELSE 0 END, " +
            "IDW_DISCOVERY = CASE WHEN <ENABLE_IDW> = 1 THEN 1 ELSE 0 END, " +
            "IEDPS_DISCOVERY = CASE WHEN <ENABLE_IEDPS> = 1 THEN 1 ELSE 0 END, " +
            "AIML_DISCOVERY = CASE WHEN <ENABLE_AIML> = 1 THEN 1 ELSE 0 END " +
